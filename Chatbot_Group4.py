...
def chatbot_answer(user_input):
    ...
    if user_input != "bye":
        ...
        questions_answers = (["name", f"{get_time()} My name is ChatBot.", f"{get_time()} I am ChatBot.", f"{get_time()} You can call me ChatBot.", f"{get_time()} .", f"{get_time()} I am ChatBot created in Python."],
                             ["time",
